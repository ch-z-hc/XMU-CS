...
<style>
  ...
  *{box-sizing:border-box}
  ...
  @media (max-width:560px){.hero-main{display:block;margin-top:8px}.hero h1{font-size:34px}.week-orb{display:flex;align-items:center;gap:8px;min-width:0;margin-top:22px;padding:12px 14px}.week-orb span{display:none}.week-orb strong{font-size:18px;margin:0}.toolbar{padding:14px}.control-copy{display:none}.week-switch{flex:1}.week-switch select{flex:1}.toggle{width:100%;justify-content:flex-end}.card{padding:17px 14px;border-radius:18px}.lesson{gap:10px;padding-right:10px}.lesson .time{min-width:76px;padding:0 11px}.lesson .class-name{display:none}.section-meta{font-size:11px}.modal-backdrop{align-items:end;padding:12px}.course-modal{width:100%;padding:24px 20px 22px;border-radius:24px 24px 15px 15px}.modal-title{font-size:21px}}
...
<div class="wrap">
  <header class="hero">
    <div class="hero-main">
      ...
      <div class="week-orb"><span>当前查看</span><strong id="heroWeek"></strong></div>
    </div>
  </header>
...
(function(){
  ...
  $('#todayDate').textContent = (DATA.dayShort[today.getDay()===0?7:today.getDay()]||'') + ' ' + today.toLocaleDateString('zh-CN',{month:'numeric',day:'numeric'});
  render();
})();
</script>
</body>
